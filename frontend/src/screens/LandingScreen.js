...
const LandingScreen = () => {
    return (
        <div className="landing-wrapper relative overflow-hidden">
            <Row className='h-100'>
                <Col className='z-1 flex flex-column justify-center items-start ph6' data-aos="fade-right">
            ...
            <Image src='/images/blobs/1.svg' className='absolute blob-container'></Image>
            <Image src='/images/blobs/2.svg' className='absolute blob-decor'></Image>
            <Image src='/images/user_interface.svg' className='absolute manypixels' data-aos="fade-left"></Image>
        </div>
    )
}
